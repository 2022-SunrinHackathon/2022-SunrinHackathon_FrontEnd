<template>
  <div class="page login-page">
    ...
    <h1>로그인</h1>
    <div class="msg">로그인할 정보를 입력해주세요.</div>
    ...
    <main>
      ...
      <div class="login-tools">
        <label class="memory-password">
          <img class="google-img img2" :src="checkBoxAfter" />
          비밀번호 기억하기
        </label>
      ...
      <button class="login black-back">
        <img class="google-img" :src="googleImg" />
        Google로 로그인
      </button>
    </main>
...
export default {
  ...
  data() {
    return {
      inputEmail: "",
      inputPassword: "",
      googleImg: require("/src/assets/login/google_logo.svg"),
      checkBoxAfter: require("/src/assets/login/check_box.svg")
    }
  }
}
</script>
